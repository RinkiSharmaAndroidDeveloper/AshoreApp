 ...
 */
public class DosagesScheduleActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date = dateHelper.convertToDate(hour, minute);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case (R.id.activity_schedule_cancel):
                Intent i_cancel = new Intent(getApplicationContext(), AddMedicineActivity.class);
