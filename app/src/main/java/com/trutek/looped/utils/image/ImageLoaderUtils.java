...
public class ImageLoaderUtils {
    ...
    public static final DisplayImageOptions UIL_USER_AVATAR_DISPLAY_OPTIONS_ROUNDED = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.drawable.default_placeholder)
            .showImageForEmptyUri(R.drawable.default_placeholder)
            .showImageOnFail(R.drawable.default_placeholder)
    ...
    public static final DisplayImageOptions UIL_USER_AVATAR_DISPLAY_OPTIONS_BLUR = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.drawable.default_blur_profile_icon)
            .showImageForEmptyUri(R.drawable.default_blur_profile_icon)
            .showImageOnFail(R.drawable.default_blur_profile_icon)
            .cacheOnDisc(true)
            .cacheInMemory(true)
            .build();

    public static final DisplayImageOptions UIL_GROUP_AVATAR_DISPLAY_OPTIONS = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.drawable.placeholder_group)
            .showImageForEmptyUri(R.drawable.placeholder_group)
            .showImageOnFail(R.drawable.placeholder_group)
            .cacheOnDisc(true)
            .cacheInMemory(true)
            .build();
