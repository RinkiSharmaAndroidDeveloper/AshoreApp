...
public class CategoryDao extends AbstractDao<Category, Long> {
    ...
    */
    ...
    private Query<Category> profile_CategoryListQuery;
    ...
    /** Internal query to resolve the "categoryList" to-many relationship of Profile. */
    public List<Category> _queryProfile_CategoryList(Long profileId) {
        synchronized (this) {
            if (profile_CategoryListQuery == null) {
                QueryBuilder<Category> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.ProfileId.eq(null));
                profile_CategoryListQuery = queryBuilder.build();
            }
        }
        Query<Category> query = profile_CategoryListQuery.forCurrentThread();
