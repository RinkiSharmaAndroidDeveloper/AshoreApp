...
public class LocationDao extends AbstractDao<Location, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ServerId = new Property(4, String.class, "serverId", false, "SERVER_ID");
        public final static Property TimeStamp = new Property(5, java.util.Date.class, "timeStamp", false, "TIME_STAMP");
        public final static Property SyncStatus = new Property(6, Integer.class, "syncStatus", false, "SYNC_STATUS");
    };
    ...
    public Location readEntity(Cursor cursor, int offset) {
        Location entity = new Location( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getInt(offset + 6) // syncStatus
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Location entity, int offset) {
        ...
        entity.setSyncStatus(cursor.isNull(offset + 6) ? null : cursor.getInt(offset + 6));
     }
